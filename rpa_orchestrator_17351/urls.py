"""rpa_orchestrator_17351 URL Configuration
...
admin.site.site_header = "rpa_orchestrator"
admin.site.site_title = "rpa_orchestrator Admin Portal"
admin.site.index_title = "rpa_orchestrator Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="rpa_orchestrator API",
        default_version="v1",
        description="API documentation for rpa_orchestrator App",
    ),
    public=True,
